<?php
    ...
    $artwork = function($parameters)
    {
        ...
        $results = $_system_registry->getModel()->query("SELECT Oeuvre.Code_Oeuvre, Oeuvre.Titre_Oeuvre as Titre_Oeuvre, Oeuvre.Sous_Titre as Sous_Titre, Oeuvre.Année_Oeuvre as Annee WHERE Oeuvre.Code_Oeuvre = '".$parameters["code"]."'")->fetch();
