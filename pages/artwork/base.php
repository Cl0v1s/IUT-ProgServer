<?php
    ...
    $artwork = function($parameters)
    {
        ...
        $sql = "SELECT DISTINCT Oeuvre.Code_Oeuvre, Composition_Oeuvre.Code_Composition, Enregistrement.Code_Morceau, Composition_Disque.Code_Disque, Album.Code_Album as Code_Album, Album.Titre_Album as Titre_Album, Album.Année_Album as Année_Album, Album.Pochette as Pochette FROM Oeuvre ";
        ...
        $parameters["Année"] = $results["Année"];
